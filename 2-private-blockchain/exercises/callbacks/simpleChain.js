...
- Navigate back to your terminal session with node REPL and past student code to test
	...
	1. Instantiate blockchain object
		Example: blockchain = new Blockchain();
...
NOTE: The steps above to test student code resulted with the genesis block being
			added to the blockchain each time the application was restarted. The solution
			is to modify the blockchain constructor to add genesis block to levelDB with
			key value 0 for the start of the dataset. Adding the genesis block to levelDB
			with the constructor is a simple method to persist the genesis block to the
			blockchain without adding new blocks upon restart.
